...
/*   Updated: 2023/06/29 15:22:25 by malancar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pipex(char *first_arg, char *last_arg, t_pipex *cmd,char **envp)
{
	while (cmd.index > 0)
	{
		if (check_command(av[i], envp, &cmd) == 0)
		{
			//si cmd invalid faire le reste
